...
// Date: May 27 2004
// Description: Interface for SWIG
// Note:
////////////////////////////////////////////////////////////////////
...
// doubleStruc
//////////////////////
%typemap(python, out) struct doubleStruct
{
  long i;
  long nSizeArray;
  double* pdArray;
...
// floatStruc
//////////////////////
%typemap(python, out) struct floatStruct
{
  long i;
  long nSizeArray;
  float* pfArray;
...
// longStruc
//////////////////////
%typemap(python, out) struct longStruct
{
  long i;
  long nSizeArray;
  long* plArray;
...
// shortStruc
//////////////////////
%typemap(python, out) struct shortStruct
{
  long i;
  long nSizeArray;
  short* pnArray;
...
// intStruc
//////////////////////
%typemap(python, out) struct intStruct
{
  long i;
  long nSizeArray;
  int* pnArray;
...
extern void Do_Metro(long, double, double, double, double*, long, long*, double*,  double*, double*, double*, double*, double*, double*,  double*, double*, double*, double*,  double*, double*, double*, long*, long*, double, long, long, long);
