...
/*-----------------------------------------------
              @(target):= _macadam.so
  ------------------------------------------------*/
#define SWIG_init    init_macadam

#define SWIG_name    "_macadam"
...
void Do_Metro(long,double,double,double,double *,long,long *,double *,double *,double *,double *,double *,double *,double *,double *,double *,double *,double *,double *,double *,double *,long *,long *,double,long,long,long);
...
extern "C" {
#endif
static PyObject *_wrap_print_args(PyObject *self, PyObject *args) {
    PyObject *resultobj;
    char **arg1 = (char **) 0 ;
    int result;
    PyObject * obj0 = 0 ;
    
    if(!PyArg_ParseTuple(args,(char *)"O:print_args",&obj0)) goto fail;
    {
        // Check if is a list 
        if (PyList_Check(obj0)) {
            int nSize = PyList_Size(obj0);
            int i = 0;
            arg1 = (char **) malloc((nSize+1)*sizeof(char *));
            for (i = 0; i < nSize; i++) {
...
static PyObject *_wrap_Do_Metro(PyObject *self, PyObject *args) {
    PyObject *resultobj;
    long arg1 ;
    double arg2 ;
    double arg3 ;
    ...
    if(!PyArg_ParseTuple(args,(char *)"OOOOOOOOOOOOOOOOOOOOOOOOOOO:Do_Metro",&obj0,&obj1,&obj2,&obj3,&obj4,&obj5,&obj6,&obj7,&obj8,&obj9,&obj10,&obj11,&obj12,&obj13,&obj14,&obj15,&obj16,&obj17,&obj18,&obj19,&obj20,&obj21,&obj22,&obj23,&obj24,&obj25,&obj26)) goto fail;
    {
    ...
    }
    {
        ...
        if (PyList_Check(obj7)) {
            long nSize = PyList_Size(obj7);
            long i = 0;
            arg8 = (double*) malloc((nSize+1)*sizeof(double));
            for (i = 0; i < nSize; i++) {
    ...
    }
    {
        ...
        if (PyList_Check(obj8)) {
            long nSize = PyList_Size(obj8);
            long i = 0;
            arg9 = (double*) malloc((nSize+1)*sizeof(double));
            for (i = 0; i < nSize; i++) {
    ...
    }
    {
        ...
        if (PyList_Check(obj9)) {
            long nSize = PyList_Size(obj9);
            long i = 0;
            arg10 = (double*) malloc((nSize+1)*sizeof(double));
            for (i = 0; i < nSize; i++) {
    ...
    }
    {
        ...
        if (PyList_Check(obj10)) {
            long nSize = PyList_Size(obj10);
            long i = 0;
            arg11 = (double*) malloc((nSize+1)*sizeof(double));
            for (i = 0; i < nSize; i++) {
    ...
    }
    {
        long i;
        // Check if is a list 
        if (PyList_Check(obj11)) {
            long nSize = PyList_Size(obj11);
            long i = 0;
            arg12 = (double*) malloc((nSize+1)*sizeof(double));
            for (i = 0; i < nSize; i++) {
                PyObject *o = PyList_GetItem(obj11,i);
                if (PyFloat_Check(o)){
    ...
    }
    {
        long i;
        // Check if is a list 
        if (PyList_Check(obj12)) {
            long nSize = PyList_Size(obj12);
            long i = 0;
            arg13 = (double*) malloc((nSize+1)*sizeof(double));
            for (i = 0; i < nSize; i++) {
                PyObject *o = PyList_GetItem(obj12,i);
                if (PyFloat_Check(o)){
    ...
    }
    {
        ...
        if (PyList_Check(obj13)) {
            long nSize = PyList_Size(obj13);
            long i = 0;
            arg14 = (double*) malloc((nSize+1)*sizeof(double));
            for (i = 0; i < nSize; i++) {
    ...
    }
    {
        ...
        if (PyList_Check(obj14)) {
            long nSize = PyList_Size(obj14);
            long i = 0;
            arg15 = (double*) malloc((nSize+1)*sizeof(double));
            for (i = 0; i < nSize; i++) {
    ...
    }
    {
        ...
        if (PyList_Check(obj15)) {
            long nSize = PyList_Size(obj15);
            long i = 0;
            arg16 = (double*) malloc((nSize+1)*sizeof(double));
            for (i = 0; i < nSize; i++) {
                PyObject *o = PyList_GetItem(obj15,i);
                if (PyFloat_Check(o)){
                    arg16[i] = PyFloat_AsDouble(o);
                }
                else{
                    PyErr_SetString(PyExc_TypeError,"list must contain double numbers");
                    free(arg16);
    ...
    }
    {
        long i;
        // Check if is a list 
        if (PyList_Check(obj16)) {
            long nSize = PyList_Size(obj16);
            long i = 0;
            arg17 = (double*) malloc((nSize+1)*sizeof(double));
            for (i = 0; i < nSize; i++) {
                PyObject *o = PyList_GetItem(obj16,i);
                if (PyFloat_Check(o)){
                    arg17[i] = PyFloat_AsDouble(o);
                }
                else{
                    PyErr_SetString(PyExc_TypeError,"list must contain double numbers");
                    free(arg17);
    ...
    }
    {
        long i;
        // Check if is a list 
        if (PyList_Check(obj17)) {
            long nSize = PyList_Size(obj17);
            long i = 0;
            arg18 = (double*) malloc((nSize+1)*sizeof(double));
            for (i = 0; i < nSize; i++) {
                PyObject *o = PyList_GetItem(obj17,i);
                if (PyFloat_Check(o)){
                    arg18[i] = PyFloat_AsDouble(o);
                }
                else{
                    PyErr_SetString(PyExc_TypeError,"list must contain double numbers");
                    free(arg18);
    ...
    }
    {
        long i;
        // Check if is a list 
        if (PyList_Check(obj18)) {
            long nSize = PyList_Size(obj18);
            long i = 0;
            arg19 = (double*) malloc((nSize+1)*sizeof(double));
            for (i = 0; i < nSize; i++) {
                PyObject *o = PyList_GetItem(obj18,i);
                if (PyFloat_Check(o)){
                    arg19[i] = PyFloat_AsDouble(o);
                }
                else{
                    PyErr_SetString(PyExc_TypeError,"list must contain double numbers");
                    free(arg19);
    ...
    }
    {
        long i;
        // Check if is a list 
        if (PyList_Check(obj19)) {
            long nSize = PyList_Size(obj19);
            long i = 0;
            arg20 = (double*) malloc((nSize+1)*sizeof(double));
            for (i = 0; i < nSize; i++) {
                PyObject *o = PyList_GetItem(obj19,i);
                if (PyFloat_Check(o)){
                    arg20[i] = PyFloat_AsDouble(o);
                }
                else{
                    PyErr_SetString(PyExc_TypeError,"list must contain double numbers");
                    free(arg20);
    ...
    }
    {
        long i;
        // Check if is a list 
        if (PyList_Check(obj21)) {
            long nSize = PyList_Size(obj21);
            long i = 0;
            arg22 = (long*) malloc((nSize+1)*sizeof(long));
            for (i = 0; i < nSize; i++) {
                PyObject *o = PyList_GetItem(obj21,i);
                if (PyInt_Check(o)){
                    arg22[i] = PyInt_AsLong(o);
                }
                else{
                    PyErr_SetString(PyExc_TypeError,"list must contain long numbers");
                    free(arg22);
    ...
    {
        arg24 = (double)(SWIG_As_double(obj23)); 
        if (SWIG_arg_fail(24)) SWIG_fail;
    }
    {
        arg25 = (long)(SWIG_As_long(obj24)); 
        if (SWIG_arg_fail(25)) SWIG_fail;
    }
    {
        arg26 = (long)(SWIG_As_long(obj25)); 
        if (SWIG_arg_fail(26)) SWIG_fail;
    }
    {
        arg27 = (long)(SWIG_As_long(obj26)); 
        if (SWIG_arg_fail(27)) SWIG_fail;
    }
...
static PyObject *_wrap_Echo(PyObject *self, PyObject *args) {
    PyObject *resultobj;
    
    if(!PyArg_ParseTuple(args,(char *)":Echo")) goto fail;
    Echo();
...
static PyObject *_wrap_mydebug(PyObject *self, PyObject *args) {
    PyObject *resultobj;
    ...
    if(!PyArg_ParseTuple(args,(char *)"OO:mydebug",&obj0,&obj1)) goto fail;
    {
        long i;
        // Check if is a list 
        if (PyList_Check(obj0)) {
            long nSize = PyList_Size(obj0);
            long i = 0;
            arg1 = (double*) malloc((nSize+1)*sizeof(double));
            for (i = 0; i < nSize; i++) {
                PyObject *o = PyList_GetItem(obj0,i);
                if (PyFloat_Check(o)){
    ...
    }
    {
        ...
        if (PyList_Check(obj1)) {
            long nSize = PyList_Size(obj1);
            long i = 0;
            arg2 = (long*) malloc((nSize+1)*sizeof(long));
            for (i = 0; i < nSize; i++) {
...
static PyObject *_wrap_get_ra(PyObject *self, PyObject *args) {
    PyObject *resultobj;
    struct doubleStruct result;
    
    if(!PyArg_ParseTuple(args,(char *)":get_ra")) goto fail;
    result = get_ra();
...
static PyObject *_wrap_get_sn(PyObject *self, PyObject *args) {
    PyObject *resultobj;
    struct doubleStruct result;
    
    if(!PyArg_ParseTuple(args,(char *)":get_sn")) goto fail;
    result = get_sn();
...
static PyObject *_wrap_get_rc(PyObject *self, PyObject *args) {
    PyObject *resultobj;
    struct longStruct result;
    
    if(!PyArg_ParseTuple(args,(char *)":get_rc")) goto fail;
    result = get_rc();
...
static PyObject *_wrap_get_rt(PyObject *self, PyObject *args) {
    PyObject *resultobj;
    struct doubleStruct result;
    
    if(!PyArg_ParseTuple(args,(char *)":get_rt")) goto fail;
    result = get_rt();
...
static PyObject *_wrap_get_ir(PyObject *self, PyObject *args) {
    PyObject *resultobj;
    struct doubleStruct result;
    
    if(!PyArg_ParseTuple(args,(char *)":get_ir")) goto fail;
    result = get_ir();
...
static PyObject *_wrap_get_sf(PyObject *self, PyObject *args) {
    PyObject *resultobj;
    struct doubleStruct result;
    
    if(!PyArg_ParseTuple(args,(char *)":get_sf")) goto fail;
    result = get_sf();
...
static PyObject *_wrap_get_fv(PyObject *self, PyObject *args) {
    PyObject *resultobj;
    struct doubleStruct result;
    
    if(!PyArg_ParseTuple(args,(char *)":get_fv")) goto fail;
    result = get_fv();
...
static PyObject *_wrap_get_fc(PyObject *self, PyObject *args) {
    PyObject *resultobj;
    struct doubleStruct result;
    
    if(!PyArg_ParseTuple(args,(char *)":get_fc")) goto fail;
    result = get_fc();
...
static PyObject *_wrap_get_fa(PyObject *self, PyObject *args) {
    PyObject *resultobj;
    struct doubleStruct result;
    
    if(!PyArg_ParseTuple(args,(char *)":get_fa")) goto fail;
    result = get_fa();
...
static PyObject *_wrap_get_g(PyObject *self, PyObject *args) {
    PyObject *resultobj;
    struct doubleStruct result;
    
    if(!PyArg_ParseTuple(args,(char *)":get_g")) goto fail;
    result = get_g();
...
static PyObject *_wrap_get_bb(PyObject *self, PyObject *args) {
    PyObject *resultobj;
    struct doubleStruct result;
    
    if(!PyArg_ParseTuple(args,(char *)":get_bb")) goto fail;
    result = get_bb();
...
static PyObject *_wrap_get_fp(PyObject *self, PyObject *args) {
    PyObject *resultobj;
    struct doubleStruct result;
    
    if(!PyArg_ParseTuple(args,(char *)":get_fp")) goto fail;
    result = get_fp();
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"mydebug", _wrap_mydebug, METH_VARARGS, NULL},
	 { (char *)"get_ra", _wrap_get_ra, METH_VARARGS, NULL},
	 { (char *)"get_sn", _wrap_get_sn, METH_VARARGS, NULL},
	 { (char *)"get_rc", _wrap_get_rc, METH_VARARGS, NULL},
	 { (char *)"get_rt", _wrap_get_rt, METH_VARARGS, NULL},
	 { (char *)"get_ir", _wrap_get_ir, METH_VARARGS, NULL},
	 { (char *)"get_sf", _wrap_get_sf, METH_VARARGS, NULL},
	 { (char *)"get_fv", _wrap_get_fv, METH_VARARGS, NULL},
	 { (char *)"get_fc", _wrap_get_fc, METH_VARARGS, NULL},
	 { (char *)"get_fa", _wrap_get_fa, METH_VARARGS, NULL},
